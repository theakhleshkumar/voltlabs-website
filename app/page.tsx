        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap items-center gap-8 pt-8">
            <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm px-5 py-3 rounded-xl border border-white/10">
              ...
              <div>
                <div className="text-white font-semibold">WiFi Connected</div>
                <div className="text-gray-400 text-sm">Control from anywhere</div>
              </div>
            </div>
            <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm px-5 py-3 rounded-xl border border-white/10">
              <svg className="w-8 h-8 text-[#EAA832]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <div className="text-white font-semibold">1 Year Warranty</div>
                <div className="text-gray-400 text-sm">Guaranteed quality</div>
              </div>
            </div>
            <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm px-5 py-3 rounded-xl border border-white/10">
              <svg className="w-8 h-8 text-[#EAA832]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <div className="text-white font-semibold">App Controlled</div>
...
const ContactSection = () => {
  ...
  // Used to measure how long the form was open; scripts submit instantly.
    ...
    try {
      const response = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...formData,
          company: honeypot,
          // Lets the server reject submissions faster than a person can type.
          ...
          <div className="bg-gray-50 rounded-3xl p-8 lg:p-12">
            ...
            {submitStatus === 'error' && (
              <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-red-800">Message not sent</p>
